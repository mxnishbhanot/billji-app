...
export function CustomerFormSheet({ visible, isEdit, form, saving, onSubmit, onClose }: Props) {
      ...
      <KeyboardAvoidingView behavior="padding" style={styles.fill}>
        ...
        >
          ...
          <View style={styles.header}>
            <Text style={[styles.title, { color: theme.colors.onSurface }]}>{isEdit ? 'Edit customer' : 'Add customer'}</Text>
          ...
          >
            ...
            <Text style={styles.saveLabel}>{isEdit ? 'Save changes' : 'Add customer'}</Text>
          </Pressable>
        </Animated.View>
